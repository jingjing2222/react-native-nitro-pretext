    ...
    <View style={localStyles.screen}>
      ...
      >
        <View style={localStyles.header}>
          <Text style={localStyles.route}>examples/use-case</Text>
          <Text style={localStyles.title}>Pretext API use cases</Text>
          <Text style={localStyles.description}>
            Each page keeps the API call in the screen file so the usage is
            visible without chasing shared abstractions.
          </Text>
        </View>
...
function UseCaseLink({
  ...
  return (
    <Pressable
      ...
      testID={`examples.use-case.open.${entry.pairId}`}
    >
